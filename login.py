...
def register_user():
    ...
    if username_info == "":
        ...
        t = (username_info, Email_info, password_info)
        mycur.execute(sql, t)
        db.commit()
...
def registration():
    ...
    Label(root1, text="").pack()
    Label(root1,text="Email :",font="bold").pack()
...
def logged():
    ...
    # Label(logg, text="Welcome {} ".format(Email_varify.get()), fg="green", font="bold").pack()
    # Label(logg, text="").pack()
...
def login_varify():
    ...
    # Ema_varify = username_varify.get()
...
def main_screen():
    ...
    Label(root,text="").pack()
    Label(root,text="").pack()
    Label(root,text="Developed By Chandni").pack()
